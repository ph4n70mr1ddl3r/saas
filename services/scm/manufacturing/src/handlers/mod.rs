...
) -> Result<axum::Json<saas_common::response::ApiResponse<Vec<crate::models::work_order::WorkOrderResponse>>>, saas_common::error::AppError> {
...
pub async fn list_boms(
    _user: saas_auth_core::extractor::AuthUser,
    axum::extract::State(state): axum::extract::State<crate::routes::AppState>,
) -> Result<axum::Json<saas_common::response::ApiResponse<Vec<crate::models::bom::BomResponse>>>, saas_common::error::AppError> {
...
pub async fn get_bom(
    ...
    axum::extract::State(state): axum::extract::State<crate::routes::AppState>,
    axum::extract::Path(id): axum::extract::Path<String>,
) -> Result<axum::Json<saas_common::response::ApiResponse<crate::models::bom::BomDetailResponse>>, saas_common::error::AppError> {
