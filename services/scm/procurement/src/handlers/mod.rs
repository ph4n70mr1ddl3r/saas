...
pub async fn list_suppliers(
    ...
    axum::Json<saas_common::response::ApiResponse<Vec<crate::models::supplier::SupplierResponse>>>,
...
pub async fn create_supplier(
    ...
    (
        ...
        axum::Json<saas_common::response::ApiResponse<crate::models::supplier::SupplierResponse>>,
    ),
    saas_common::error::AppError,
> {
    ...
    Ok((
        ...
        axum::Json(saas_common::response::ApiResponse::new(supplier)),
    ))
}
...
pub async fn list_purchase_orders(
    ...
    axum::Json<
        saas_common::response::ApiResponse<
            Vec<crate::models::purchase_order::PurchaseOrderResponse>,
        >,
    >,
    saas_common::error::AppError,
> {
...
pub async fn create_purchase_order(
    ...
    (
        ...
        axum::Json<
            saas_common::response::ApiResponse<
                crate::models::purchase_order::PurchaseOrderResponse,
            >,
        >,
    ),
    saas_common::error::AppError,
...
pub async fn get_purchase_order(
    ...
    axum::Json<
        saas_common::response::ApiResponse<
            crate::models::purchase_order::PurchaseOrderDetailResponse,
        >,
    >,
    saas_common::error::AppError,
> {
