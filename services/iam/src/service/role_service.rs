...
impl RoleService {
    pub fn new(pool: SqlitePool, bus: NatsBus) -> Self {
        Self { repo: RoleRepo::new(pool), bus }
    }
    ...
    pub async fn set_permissions(&self, role_id: &str, permission_ids: Vec<String>) -> AppResult<()> {
        self.repo.set_role_permissions(role_id, &permission_ids).await
    }
}
